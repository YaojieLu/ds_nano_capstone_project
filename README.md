...
The following files attached to this GitHub's repository include the following and for the following reasons:
 ...
 - **analysis.py**: This is where I performed all my analysis work.
 - **preprocessing.py**: This and the below three scripts are where I performed preprocessing.
 - **spending.py**: the spending for each person_id-offer_id pair
 - **viewed.py**: viewed or not for each person_id-offer_id pair
 - **completed.py**: completed or not for each person_id-offer_id pair
